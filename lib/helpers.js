...
function _cleanAddr(theIpAddress){
  ...
  // return theIpAddress.replace(/[^0-9.]{0,20}([^0-9.]{7,21})$/i, "$1");
}

function _logEntry(theMethod, theUri, clientAddr){
  return {method: theMethod, uri: theUri, client: _cleanAddr(clientAddr), timestamp: _timeStamp()};
}
